...
public class FindLVAdapter extends BaseAdapter{
    ...
    private int[] a=new int[]{R.mipmap.home_videolive_btn_normal,R.mipmap.home_cafe_btn_pressed,R.mipmap.home_shop_btn_normal,R.mipmap.ic_launcher,R.mipmap.ic_launcher};
